...
public class Main {
    public static void main(String[] args) {
        ...
        //Biến static: Khi bạn muốn một biến có giá trị chung và được chia sẻ bởi tất cả các đối tượng của lớp,
        // bạn nên sử dụng biến static.

        // Biến static chỉ được khởi tạo một lần và giữ giá trị của nó trong suốt quá trình thực thi chương trình.

        //Phương thức static: Khi bạn muốn một phương thức có thể được gọi mà không cần tạo một đối tượng của lớp,
        // bạn nên sử dụng phương thức static.
        ...
        // Để truy cập đến phương thức hoặc thuộc tính static trong Java, bạn có thể sử dụng tên của lớp chứa chúng, theo sau là dấu chấm
        //(.) và tên của phương thức hoặc thuộc tính. Bạn không cần tạo một đối tượng của lớp để truy cập đến các thành viên static.
        ...
        //Biến final: Khi một biến được khai báo là final, giá trị của nó không thể thay đổi sau khi đã được khởi tạo.
...
//        final int myFinalVariable = 10;
        ...
        // Biến static: Biến static là một biến chung của lớp, không thuộc về một đối tượng cụ thể nào của lớp.
...
//        static int myStaticVariable = 10;
        ...
        //Nếu một biến được khai báo là final, bạn không thể thay đổi giá trị của nó sau khi đã khởi tạo.
