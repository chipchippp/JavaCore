...
//            }
        ...
        class Animal {
            ...
            public Animal(String name) {
                this.name = name; // this tham chiếu đến biến instance 'name'
            }
            void makeSound() {
                System.out.println(this.name + " makes a generic animal sound.");
            } // Phương thức makeSound sử dụng this để truy cập biến instance
        }
        class Dog extends Animal {
            ...
            public void introduce() {
                System.out.println("This dog's breed is: " + this.breed);
        ...
        myDog.makeSound(); //  result: This dog's breed is: Golden Retriever
